...
$include_modal_top = !empty( $param[ 'modal_top' ] ) ? 'top: ' . $param[ 'modal_top' ] . '%;' : 'top: 0;';
...
$close_type = !empty( $param['close_type'] ) ? $param['close_type'] : 'image';
...
$close_bottom_position = !empty( $param[ 'close_bottom_position' ] ) ? $param[ 'close_bottom_position' ] : '0';
