...
class WPBForWPbakery_Product_Rating{
    ...
    public function render_shortcode( $atts, $content = null ) {
        ...
        $output = '<style>';
        $output .= ".$unique_class .star-rating span::before{color: {$rating_color};}";
        $output .= ".$unique_class a.woocommerce-review-link{color: {$link_color};}";
        $output .= ".$unique_class a.woocommerce-review-link:hover{color: {$link_hover_color};}";
        $output .= '</style>';
