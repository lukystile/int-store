...
class WPBForWPbakery_Product_Archive{
    ...
    public function render_shortcode( $atts, $content = null ) {
        ...
        $settings = array(
        	...
        	'orderby' => $orderby,
        	'order' => $order,
        	'query_post_type' => get_queried_object()
        );

        add_filter( 'product_custom_limit', array( $this, 'wpbforwpbakery_custom_product_limit' ) );
        $shortcode = new WPBForWPbakery_Archive_Products_Render( $settings );
        ...
        if($current_theme == 'Flone'){
        	...
        	<div class="shop-top-bar">
        		...
        		<?php if($settings['allow_order'] == 'yes'): ?>
