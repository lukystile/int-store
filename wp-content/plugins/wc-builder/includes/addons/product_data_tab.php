...
class WPBForWPbakery_Product_Data_Tab{
    ...
    public function render_shortcode( $atts, $content = null ) {
        ...
        $output = '<style>';
        $output .= ".woocommerce .$unique_class .woocommerce-tabs ul.tabs li a{ color: {$tab_title_color}; font-size:{$tab_title_font_size}; line-height:{$tab_title_line_height}; }";
        $output .= ".woocommerce .$unique_class .woocommerce-tabs ul.tabs li.active a{ color: {$active_tab_title_color}; }";
        $output .= ".woocommerce .$unique_class .woocommerce-Tabs-panel h2{ color: {$tab_heading_color}; font-size:{$tab_heading_font_size}; line-height:{$tab_heading_line_height}; }";
        $output .= '</style>';
