...
<?php } elseif($blog_style_ot == 'blog_style_ot_3') {
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class('jt-blog-slide jt-style-three-blog jt-normal-view'); ?>>
		<img src="<?php echo esc_attr($blog_img); ?>" alt="<?php the_title(); ?>">
...
<?php } elseif($blog_style_ot == 'blog_style_ot_4') { ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('jt-each-post'); ?>>
		<?php
		$aud_cont = get_post_meta( $post->ID, 'audio_content', true );
		if($aud_cont) {
			echo $aud_cont;
			...
			$url = $thumb['0'];
		?>
			<a href="<?php echo esc_url($url); ?>" class="format-image-popup jt-featured-img">
				<?php the_post_thumbnail(); ?>
			</a>
		<?php } elseif(!has_post_thumbnail()) { ?>
			<a href="<?php echo IMAGES; ?>/dummy/blog.png" class="format-image-popup jt-featured-img">
