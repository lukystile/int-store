...
// we set the 'fx' class on the first image when the page loads
  document.getElementById('kenburn-slide').getElementsByTagName('img')[0].className = "fx";
...
// if it is set to 1 (instead of 0) it is because the first image is styled when the page loads
  var images          = document.getElementById('kenburn-slide').getElementsByTagName('img'),
