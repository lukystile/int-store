...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	require_once( FRAMEWORK . '/plugins/import/importer/radium-importer.php' ); //load admin theme data importer
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function __construct() {
			...
			$this->demo_files_path = FRAMEWORK . '/plugins/import/demo-files/'; // can
		...
		public function set_demo_menus(){
			...
			// $main_menu   = get_term_by('main-menu', 'main-menu', 'main-menu');
